...
?>
 ...
 <h1 class="counter_value mt-12" data-target="370">POLICY&nbsp;MEASURES&nbsp;TO&nbsp;INCREASE &nbsp; IMPACTS OF ARTS TO&nbsp;HEALTH</h1>
                        <p class="mb-0 mt-2 text-uppercase">Generated by CHAT-GPT </p>
                    </div>
                </div>
	        </div>
        </div>
...
<?php
$sql="SELECT text FROM `impacty` where  row= 100 "  ;
...
<table id="Article" class="display" >
 <thead>
 <tr>
 <th><center>Policy measures</center></th>
