...
?>
 ...
 <h1 class="counter_value mt-12" data-target="370">DOMAIN CANDIDATE TRANSITION VARIABLES</h1>
                        <p class="mb-0 mt-2 text-uppercase">Candidate transition variables for cultural domain
</p>
                    </div>
                </div>
	        </div>
...
<?php
$sql="SELECT * FROM `function` where  Domain =  ". (int)$DOMAIN . " and ID_doc < 1000 limit 1000" ;
