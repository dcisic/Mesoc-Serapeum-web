...
?>
 ...
 <h1 class="counter_value mt-12" data-target="370">MESOC Taxonomy graph for impact of arts to health</h1>
...
<?php
$sql = "SELECT * FROM `node` WHERE grupa in ( 3, 5)  ";
