...
<script src="add/webcomponents-loader.js"></script>
<script src="add/bootstrap.min.js"></script>
<script src="add/custom-elements-es5-adapter.js"></script>
<meta charset="UTF-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
				    ...
				    <br>       <br>   <br>   <br>   <br> 		
 <h1 class="counter_value mt-12" data-target="370"> FIND IMPACT  FOR ARTICLE </h1>
                        <p class="mb-0 mt-2 text-uppercase"> Analyze article and determine social impact
                    </div>
                </div>
	        </div>
        </div>
...
<?php
$sql1="SELECT Impact  FROM `docx`where Id_Doc =" . (int)$ID;
...
$words=explode(",",$all) ;
?>
<td style="background-color:  #D3D3D3;"><B>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Impact&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
</td>
...
<tr><td><b> <?php  echo $words[0] ?></p> </b> </td>
