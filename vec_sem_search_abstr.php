...
$.ajax({            datatype:'json',
					type: 'GET',
					url: <?php echo $link ; ?>vecsrcha?quest='+document.getElementById("Quest").value,
                    success: function(response) {

               for(var i=0; i<1; i++){

                var tr_str =
                    "<tr><td width='20%'> Document </td><td align='center'><a href='article.php?id="+response[i].ID_Doc + "' ><img src='images/view.png'  style='border: 0' alt='View'></a>" + response[i].ID_Doc + "</td> </tr>" +
                    "<tr><td width='20%'> Distance </td><td align='center'>" + response[i].Distance.toFixed(2) + "</td></tr>" +
                    "<tr><td width='20%'> Title </td><td align='center'><b>" + response[i].Title + "</td> </tr>"+ "<tr><td width='20%'> Abstract </td><td align='justify'>" + response[i].Abstract + "</td></tr>";
